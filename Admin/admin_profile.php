...
<aside> 
    ...
    <div class="container">
      ...
      <form class="form-horizontal" action="/action_page.php" style="margin-left:100px;">
        <div class="form-group">
          <label class="control-label col-sm-2" for="aadhar">Aadhaar ID:</label>
          <div class="col-sm-10">
        ...
        <div class="form-group">        
          <div class="col-sm-offset-2 col-sm-10">
            <center><button type="submit" class="btn btn-success" style="margin-bottom:25px;">Submit</button></center>
          </div>
        </div>
      </form>
    </div>
